...
class _MilestoneDetailScreenState extends ConsumerState<MilestoneDetailScreen> {
  ...
  void initState() {
    ...
    whyPoints = MilestoneHelpers.buildWhyPoints(
      widget.milestone,
      widget.survey,
    );
  }
  ...
  int get _nextAllowedIndex =>
      _checkedSteps.isEmpty ? 0 : (_checkedSteps.toList()..sort()).last + 1;
    ...
    if (_checkedSteps.contains(index)) {
      ...
      if (index == maxChecked) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text(
              '⚠️ You can only undo the most recently completed step.',
            ),
            behavior: SnackBarBehavior.floating,
          ),
        );
  ...
  void _showGuidedTaskSheet(int index, String stepText) {
    ...
    showModalBottomSheet(
      ...
      builder: (ctx) => GuidedTaskSheet(
        ...
        toolUrl: widget.milestone.toolUrl,
          ...
          Padding(
            ...
            child: Center(
              child: Container(
                ...
                child: Text(
                  '${_checkedSteps.length}/${m.steps.length} steps',
                  style: TextStyle(
                    fontSize: 11,
                    fontWeight: FontWeight.w700,
              ...
              child: Column(
                ...
                children: [
                  ...
                  _StepsHeader(
                    ...
                    onToggleAlt: () =>
                        setState(() => _showAlternative = !_showAlternative),
                  ),
                  const SizedBox(height: 4),
                  _StepHint(
                    allDone: _allDone,
                    nextIndex: _nextAllowedIndex,
                    hasAlt: hasAlt,
                  ),
    ...
    return Column(
      children: [
        Row(
          ...
          children: [
            Text(
              '$checkedCount of $total steps done',
              style: const TextStyle(
                fontSize: 12,
                color: AppTheme.textMuted,
                fontWeight: FontWeight.w600,
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: showAlternative ? _kPurple300 : AppTheme.border,
                ),
              ),
              child: Text(
      ...
      return Container(
        ...
        child: const Row(
          children: [
            ...
            Expanded(
              child: Text(
                'All steps complete! Tap below to earn your XP.',
                style: TextStyle(
                  fontSize: 12,
...
class _StepCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (isChecked) {
      ...
      bgColor = AppTheme.greenPale;
    } else if (isActive) {
      borderColor = AppTheme.blue;
      bgColor = AppTheme.bluePale;
    } else if (isAlternative) {
      borderColor = _kPurple200;
      bgColor = _kPurple50;
    } else if (isLocked) {
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: (isChecked || isLocked || isAlternative)
              ? const []
              : AppTheme.cardShadow,
        ),
        child: Row(
  ...
  Widget build(BuildContext context) {
    ...
    if (isLocked)
      return Container(
        ...
        child: const Center(
          child: Icon(Icons.lock_rounded, size: 13, color: AppTheme.textMuted),
        ),
      );
    if (isAlt) {
      return Container(
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 2),
                    Text(
                      'A different path to the same outcome — use if main steps are blocked.',
                      style: TextStyle(
                        fontSize: 11,
                        color: _kPurple700,
                        height: 1.4,
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '${resources.length} resources for $country',
                    style: const TextStyle(
                      fontSize: 11,
                      color: AppTheme.textMuted,
                    ),
            ...
            if (resources.length >= 2)
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Text(
                    showComparison ? '📋 Cards' : '⚖️ Compare',
                    style: TextStyle(
                      fontSize: 11,
                      fontWeight: FontWeight.w700,
